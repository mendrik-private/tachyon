...
impl ClipboardItem {
    ...
    /// Attach an alternative HTML representation to a single text item.
    /// Linux clipboard backends may publish this as `text/html`.
    #[cfg(target_os = "linux")]
    ...
    /// HTML alternative, without replacing the text or private metadata.
    #[cfg(target_os = "linux")]
