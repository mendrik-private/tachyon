...
For each target, start the compositor with `TACHYON_WESTON_SCALE_120` set to the corresponding protocol value and load both generated modules:

```sh
TACHYON_WESTON_SCALE_120=150 weston --backend=headless --renderer=gl \
  --width=1280 --height=900 --socket=tachyon-fixture --idle-time=0 \
...
WAYLAND_DISPLAY=tachyon-fixture target/release/tachyon performance/visual-fixture.md
WAYLAND_DISPLAY=tachyon-fixture weston-screenshooter
```
