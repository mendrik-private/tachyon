...
```sh
performance/run-release-qualification.py --startup-runs 2 --interaction-runs 1 --seconds 3 --warmup-ms 500 --output /tmp/tachyon-qualification-smoke.json
```
