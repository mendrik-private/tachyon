...
page. For a release tagged `v0.1.2`, verify and run it with:

```sh
sha256sum --check SHA256SUMS
tar -xzf tachyon-v0.1.2-linux-x86_64.tar.gz
./tachyon-v0.1.2-linux-x86_64/bin/tachyon path/to/document.md
```
