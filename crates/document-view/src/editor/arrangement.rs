...
pub(super) mod tests {
    ...
    fn retained_segment_geometry_matches_uncached_renderer_across_inputs(
        ...
        cx.update(|cx| {
            ...
            let zoomed = FontMeasurement::new(cx.text_system().clone(),"Spline Sans Tachyon".into(),2.);
    ...
    fn scoped_reflow_measures_only_requested_chapters_and_retains_completed_rows(
        ...
        cx.update(|cx| {
            ...
            let fresh = FontMeasurement::new(cx.text_system().clone(), "Spline Sans Tachyon".into(), 1.);
